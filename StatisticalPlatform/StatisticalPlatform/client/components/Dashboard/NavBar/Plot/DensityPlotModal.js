...
class DensityPlotModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false
  ...
  handleClick = () => {
		this.props.onClose({showDensityPlot: false});
    this.props.onClick(
      this,
      this.first.value,
    );
  ...
  render(){
    ...
    return(
      <div className="modal-container">
          ...
          <Modal.Footer>
            <Button onClick={()=>{this.props.onClose({showDensityPlot: false})}}>Close</Button>
...
export default DensityPlotModal;
